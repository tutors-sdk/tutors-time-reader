  ...
  <a target="_blank" href="https://tutors.dev">
    <div class="navbar-icon">
      ...
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <g>
          <path fill="#fff" d="M51.5,0H3C1.4,0,0,1.4,0,3v33.3c0,1.7,1.4,3,3,3h48.5c1.7,0,3-1.4,3-3V3C54.5,1.4,53.1,0,51.5,0z M50,34.8H4.5
 V4.5H50V34.8z" />
          <g>
            <rect fill="#fff" x="29" y="26.5" width="12.1" height="4.2" />
            <g>
              <path fill="#fff" d="M13.4,13.5V8.7h19.1v4.8H26v17.2h-5.9V13.5H13.4z" />
            </g>
          </g>
        </g>
      </svg>
