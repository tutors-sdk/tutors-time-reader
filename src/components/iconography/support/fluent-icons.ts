export const FluentIconLib = {
  ...
  // companion Icons
  slack: { icon: "fluent:chat-24-filled", colour: "error" },
  moodle: { icon: "fluent:hat-graduation-24-filled", colour: "warning" },
  ...
  // tutors time icons
  tutorsTime: { icon: "fluent:clock-alarm-24-filled", colour: "info" },
